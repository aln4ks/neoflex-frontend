...
export const Footer = () => {
    return  <div className='footer'>
        <div><Link to='/' className='title'>QPick</Link></div>
        <div className="links">
            <ul>
                <Link><li><p>Избранное</p></li></Link>
                <Link to='/cart'><li><p>Корзина</p></li></Link>
                <Link><li><p>Контакты</p></li></Link>
            </ul>
        </div>
        <div className="linksLang">
            <Link><p>Условия сервиса</p></Link>
            <div className="lang">
            <ul>
                <li><Globe size={20} /></li>
                <li>Каз</li>
